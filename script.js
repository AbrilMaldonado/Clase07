  ...
  switch (menu) {
    case 1: // Cobrar
      do {
              ...
              suma = suma + precio;
              alert("El total es igual a $" + suma);
      } while (precio != 0);
    ...
    case 2://retirar dinero de la caja
        ...
        if (totalEfectivoCaja > retiro) {
                ...
                alert("Usted retiro $" + retiro + ", ahora su saldo de caja es $" + totalEfectivoCaja);
        }else{
    ...
    case 3:// balance de caja
        ...
        if (balance===1) {
          alert("Se pago con efectivo una suma de $" + suma);
    ...
    case 4:// monto total de las operaciones
          ...
          alert("El monto total de las operaciones es igual a $" + suma);
